...
class StableDiffusion3ControlNetPipeline(
    ...
    def __call__(
        ...
        Args:
            ...
            guidance_steps (`int`, *optional*, defaults to `num_inference_steps`):
                Number of initial steps where ControlNet guidance is applied. If not set, ControlNet is applied for all steps.
            sigmas (`List[float]`, *optional*):
        ...
        # 如果未设置 guidance_steps，则默认为 num_inference_steps
        if guidance_steps is None:
            guidance_steps = num_inference_steps
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # 根据 guidance_steps 控制 controlnet 的应用
                if i < guidance_steps:
                    ...
                    # 当 i >= guidance_steps 时，不使用 controlnet
                ...
                noise_pred = self.transformer(
                    ...
                    block_controlnet_hidden_states=control_block_samples, # 传入计算得到的或 None
                    joint_attention_kwargs=self.joint_attention_kwargs,
                    return_dict=False,
                )[0]
